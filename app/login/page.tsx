...
function LoginForm() {
  ...
  useEffect(() => {
    // Prefetch dashboard route in background for instant transition
          ...
          <GlassCard className="p-8 sm:p-10 border-white/15 shadow-2xl">
            ...
            <div className="text-center space-y-3 mb-8">
              ...
              <p className="text-xs sm:text-sm text-white/60 leading-relaxed max-w-xs mx-auto">
                Sign in with your Google account to access your digital memory vault.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/10 space-y-3 mb-8 text-xs text-white/70">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span>Instant Vault Restoration Across All Devices</span>
              </div>
            </div>
            ...
            <div className="mt-8 text-center text-xs text-white/50 pt-4 border-t border-white/10 space-y-2">
              <p>
                ...
                <Link href="/signup" className="text-aurora-cyan font-semibold hover:underline">
                  Sign Up
                </Link>
              </p>
              <p className="text-[11px] text-white/40">
                Protected by Aurora Vault Security &bull; Single Sign-On
              </p>
            </div>
          </GlassCard>
        </motion.div>
